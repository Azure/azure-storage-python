...
class AppendBlobSamples():  

    def __init__(self, account):
        self.account = account

    def run_all_samples(self):
        self.service = self.account.create_append_blob_service()
    ...
    def _create_blob(self, container_name, prefix='blob'):
        ...
        self.service.create_blob(container_name, blob_name)
        return blob_name
    ...
    def blob_properties(self):
        ...
        metadata = {'val1': 'foo', 'val2': 'blah'}
        self.service.create_blob(container_name, blob_name, metadata=metadata)
    ...
    def blob_with_bytes(self):
        ...
        # Basic
        # Blob must be created before it is appended to
        data = b'hello world'     
        self.service.create_blob(container_name, blob_name)
        self.service.append_blob_from_bytes(container_name, blob_name, data)
        ...
        blob_name = self._get_blob_reference()
        self.service.create_blob(container_name, blob_name)
        self.service.append_blob_from_bytes(container_name, blob_name, data, index=3)
    ...
    def blob_with_stream(self):
        ...
        self.service.create_blob(container_name, blob_name)
        self.service.append_blob_from_stream(container_name, blob_name, 
                                             input_stream, 15)
    ...
    def blob_with_path(self):
        ...
        # Blob must be created before it is appended to
        self.service.create_blob(container_name, blob_name)
        self.service.append_blob_from_path(container_name, blob_name, INPUT_FILE_PATH)
    ...
    def blob_with_text(self):
        ...
        data = u'hello world, '
        self.service.create_blob(container_name, blob_name)
        self.service.append_blob_from_text(container_name, blob_name, data)
        ...
        self.service.create_blob(container_name, blob_name)
        self.service.append_blob_from_text(container_name, blob_name, text, 'utf-16')
    ...
    def append_block(self):
        ...
        # Basic
        self.service.append_block(container_name, blob_name, b'hello world, ')

        # Conditional on size
        # If adding this data would result in the blob being larger than 50 bytes, fail
        self.service.append_block(container_name, blob_name, b'hello world, ', maxsize_condition=50)

        # Conditional position
        # If the blob size is not currently 24, fail
        self.service.append_block(container_name, blob_name, b'hello world', appendpos_condition=26)